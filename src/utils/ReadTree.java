...
public class ReadTree {
	...
	public void aggregateTimeStampedProjects() throws IOException {
		...
		for(int i=0;i<userProject.size()-1;i++) {
			...
			makeComparison(instance1,instance2,instance1.getName(),instance2.getName());
		}
		updateCSV();
	}
	/**
	 ...
	 * @throws IOException
	 */
	private void makeComparison(Tree<Block> first, Tree<Block> second,String firstNo, String secondNo) throws IOException {
